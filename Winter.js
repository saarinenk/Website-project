    ...
    Winter.prototype = {
        ...
        create: function () {
            this.stage.backgroundColor = '#37dbce';
            this.map = this.add.tilemap('winter');
            this.map.addTilesetImage('tilesetit_winter', 'tilesetit_winter');
            ...
            this.car = this.add.sprite(304, 224, 'busup');
            ...
            var goal = this.goal.create(96,0,'goal', null);
            goal.loadTexture('transparent');
            goal.body.immovable = true;
            
            /* Passengers */
            this.humans = this.add.physicsGroup(); //hh
            var passenger1 = this.humans.create(96,96, 'human', null);
            var passenger2 = this.humans.create(64,416, 'human', null);
            var passenger3 = this.humans.create(192,288, 'human', null);
            var passenger4 = this.humans.create(416,288, 'human', null);
            var passenger5 = this.humans.create(512,128, 'human', null);
            ...
            passenger5.loadTexture('transparent');
            
            this.move(Phaser.UP);
            
            this.add.button(Winter.GAME_WIDTH-50-0, 0, 'pauseb', this.managePause, this);
            ...
            var obstacle1 = this.obs.create(480, 96, 'obstacle', null);
            obstacle1.loadTexture('cone_horizontal');
            obstacle1.body.immovable = true;
            
            var obstacle2 = this.obs.create(384, 128, 'obstacle', null);
            obstacle2.loadTexture('cone_vertical');
            obstacle2.body.immovable = true;
            
            var obstacle3 = this.obs.create(448, 224, 'obstacle', null);
            obstacle3.loadTexture('cone_horizontal');
            obstacle3.body.immovable = true;
            
            var obstacle4 = this.obs.create(576, 64, 'obstacle', null);
            obstacle4.loadTexture('cone_vertical');
            obstacle4.body.immovable = true;
            
            this.scoreText = this.add.text(460, 5, "Passengers: " + this.score.toString() + "/5", {
                font: "18px Orbitron",
                fill: "#ffffff",
                align: "center",
                stroke: "black",
            ...
            this.counterText = this.add.text(132, 5, "Pollution: " + (100 - this.counter).toString() + "%", {
                font: "18px Orbitron",
                fill: "#ffffff",
                align: "center",
                stroke: "black",
            ...
            this.time.events.loop(Phaser.Timer.SECOND * 0.4, this.updateCounter, this);
        ...
        pickup: function (car, human) { //hh
            ...
            human.kill();
            this.score++;
            this.scoreText.setText("Passengers: " + this.score.toString() + "/5")
            if(this.score === 5) {
        ...
        crash: function (car, obstacle) {
            this.score = 0;
            this.explosion.play();
            this.game.state.start("GameOver4");
        },
        ...
        update: function () {
            ...
            {
                this.add.sprite(128, 96, 'bs');
            }
            if (this.directions[Phaser.DOWN].index === 76)
            {
                this.add.sprite(64, 448, 'bs');
            }
            if (this.directions[Phaser.LEFT].index === 77)
            {
                this.add.sprite(160, 288, 'bs');
            }
            if (this.directions[Phaser.RIGHT].index === 76)
            {
                this.add.sprite(448, 288, 'bs');
            }
            if (this.directions[Phaser.LEFT].index === 106)
            {
                this.add.sprite(480, 128, 'bs');
            }
