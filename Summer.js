    ...
    Summer.prototype = {
        ...
        create: function () {
            this.stage.backgroundColor = '#006400'
            this.map = this.add.tilemap('summer');
            ...
            var passenger1 = this.humans.create(192,32, 'human', null);
            var passenger2 = this.humans.create(32,288, 'human', null);
            var passenger3 = this.humans.create(224,352, 'human', null);
            var passenger4 = this.humans.create(256,96, 'human', null);
            var passenger5 = this.humans.create(416,96, 'human', null);
            ...
            this.add.button(Summer.GAME_WIDTH-50-0, 0, 'pauseb', this.managePause, this);
            ...
            var obstacle1 = this.obs.create(224, 288, 'obstacle', null);
            obstacle1.loadTexture('cone_horizontal');
            obstacle1.body.immovable = true;
            
            var obstacle2 = this.obs.create(32, 160, 'obstacle', null);
        ...
        update: function () {
            ...
            {
                this.add.sprite(192, 0, 'bs');
            }
            if (this.directions[Phaser.LEFT].index === 77)
            {
                this.add.sprite(0, 288, 'bs');
            }
            if (this.directions[Phaser.UP].index === 76)
            {
                this.add.sprite(224, 320, 'bs');
            }
            if (this.directions[Phaser.DOWN].index === 77)
            {
                this.add.sprite(256, 128, 'bs');
            }
            if (this.directions[Phaser.DOWN].index === 106)
            {
                this.add.sprite(416, 128, 'bs');
            }
